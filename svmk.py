...
# IMPORTANT: Define the Authorization Bearer token heres
...
def create_base_payload(record):
    ...
    payload = {
        "streetVendingDetail": {
            ...
            "vendingActivity": str(record.get('vendingActivity', '')),
...
#=TEXT(RANDBETWEEN(10000000,99999999),"00000000") & "-" & 
#TEXT(RANDBETWEEN(1000,9999),"0000") & "-" & 
#TEXT(RANDBETWEEN(1000,9999),"0000") & "-" & 
#TEXT(RANDBETWEEN(1000,9999),"0000") & "-" & 
#TEXT(RANDBETWEEN(100000000000,999999999999),"000000000000")
